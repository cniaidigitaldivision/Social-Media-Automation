 ...
 * Will show a queue of posts pending approval for this workspace, with tabs
 * for Pending / Approved / Rejected, full post preview, approve/reject actions,
 * and a "Request Changes" flow.
 *
 * Data: approvals table joined with posts, filtered by workspace_id.
 */
export default function ApprovalsPage() {
  return <UnbuiltFeature name="Approvals" description="Post approval queue with pending/approved/rejected tabs, preview, and approve/reject/request-changes actions." />;
}
