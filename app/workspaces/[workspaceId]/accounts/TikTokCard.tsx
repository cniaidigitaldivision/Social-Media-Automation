...
export function TikTokCard({ workspaceId, connectedAccount }: TikTokCardProps) {
  const [modalOpen, setModalOpen] = useState(false);

  if (connectedAccount) {
    // ── Connected state — identical to LinkedInCard connected layout ─────────
    ...
    return (
      <div className={`account-platform-card acct-card-linked ${borderClass}`}>
        ...
        <div className="account-card-header">
          <div className="platform-logo-box">{icons.tiktok}</div>
        ...
        <div className="account-card-body">
          ...
          <div className="acct-meta-block">
            <span className="acct-meta-line">
              <span className="acct-meta-label">Buffer ID</span>
  ...
  // ── Not connected state — identical to LinkedInCard not-connected layout ───
  return (
    <>
      <div className="account-platform-card">
        ...
        <div className="account-card-body">
          <p className="platform-display-name">TikTok</p>
        </div>
