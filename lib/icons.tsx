...
export const icons = {
  cniLogo: (
    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="icon-brand">
      <rect width="40" height="40" rx="10" fill="#005952" />
  ...
  composer: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9" /><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" /></svg>,
  ...
  approvals: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 11l3 3L22 4" /><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" /></svg>,
  ...
  leads: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>,
  ...
  moreHorizontal: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="1" /><circle cx="19" cy="12" r="1" /><circle cx="5" cy="12" r="1" /></svg>,
  ...
  uploadCloud: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 16 12 12 8 16" /><line x1="12" y1="12" x2="12" y2="21" /><path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3" /><polyline points="16 16 12 12 8 16" /></svg>,
  ...
  speaker: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" /><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07" /></svg>,
  ...
  instagram: (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <radialGradient id="ig-grad" cx="12" cy="12" r="12" gradientUnits="userSpaceOnUse">
      ...
      <rect x="4" y="4" width="16" height="16" rx="4" stroke="white" strokeWidth="1.8" />
    </svg>
  ),
  ...
  tiktok: (
    <svg viewBox="0 0 24 24" fill="#000000" xmlns="http://www.w3.org/2000/svg">
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.298 0 .59.043.87.126V9.41a6.33 6.33 0 0 0-.87-.06A6.34 6.34 0 0 0 3.14 15.7a6.34 6.34 0 0 0 10.77 4.54 6.3 6.3 0 0 0 1.91-4.54V9.06a8.28 8.28 0 0 0 4.77 1.51v-3.45a4.83 4.83 0 0 1-1-.43z" />
    </svg>
  ),
  ...
  googleBusiness: (
    <svg viewBox="0 0 24 24" fill="#4285F4" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14.5v-9l7 4.5-7 4.5z" />
    </svg>
  ),
  pinterest: (
    <svg viewBox="0 0 24 24" fill="#E60023" xmlns="http://www.w3.org/2000/svg">
  ...
  threads: (
    <svg viewBox="0 0 24 24" fill="#000000" xmlns="http://www.w3.org/2000/svg">
      <path d="M16.923 11.666c0 2.684-2.186 4.87-4.881 4.87-2.695 0-4.88-2.186-4.88-4.87s2.185-4.87 4.88-4.87c1.393 0 2.671.583 3.57 1.543l1.83-1.83c-1.4-1.428-3.32-2.315-5.4-2.315-4.218 0-7.643 3.42-7.643 7.472s3.425 7.471 7.643 7.471c4.086 0 7.438-3.21 7.63-7.262h-2.75zm-4.881-2.128c1.171 0 2.122.95 2.122 2.128 0 1.178-.951 2.128-2.122 2.128-1.17 0-2.12-.95-2.12-2.128 0-1.178.95-2.128 2.12-2.128zM12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2z" />
    </svg>
  ),
